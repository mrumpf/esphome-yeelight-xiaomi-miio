...
| `yeelight-galaxy-ceiling-light-450` | none — no upstream supports YLXD16YL | — | scaffold, model unconfirmed |
| `smart-desk-lamp-1s-{unit,unit,unit}` | `packages/hardware/desk-lamp-1s.yaml` | GPIO map from the [Tasmota template](https://templates.blakadder.com/xiaomi_MJTD01SYL.html) | not flashed yet |
